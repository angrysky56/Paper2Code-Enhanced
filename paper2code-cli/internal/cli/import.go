...
but do not stop the import.`,
  ...
  paper2code-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  paper2code-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | paper2code-pp-cli import <resource> --input -`,
