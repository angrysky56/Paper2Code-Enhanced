...
large datasets as it has no memory pressure.`,
  ...
  paper2code-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  paper2code-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  paper2code-pp-cli export <resource> --format jsonl | jq '.id'`,
