# Paper2code Printed CLI Agent Guide

This directory is a generated `paper2code-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
paper2code-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
paper2code-pp-cli which "<capability>" --json
paper2code-pp-cli <command> --help
```
...
```bash
paper2code-pp-cli <command> --agent
```
...
```bash
paper2code-pp-cli <command> --help
paper2code-pp-cli <command> --dry-run --agent
```
